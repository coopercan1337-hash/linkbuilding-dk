    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-4 flex justify-between items-center">
          <Link to="/" className="text-xl font-bold text-blue-700">Link-Eksperten.dk</Link>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <article className="bg-white rounded-lg shadow-sm p-8 prose prose-lg max-w-none">
          <h1 className="text-4xl font-bold mb-6">Om Link-Eksperten.dk</h1>

          <section className="mb-8">
            <h2 className="text-2xl font-bold mt-8 mb-4">Vores mission</h2>
            <p className="text-gray-700 leading-relaxed">
              Link-Eksperten.dk blev skabt for at hjælpe danske virksomheder med at finde den bedste og mest 
              overkommelige linkbuilding (Legal Entity Identifier) til deres behov. Vi ved, at det kan være 
              forvirrende at navigere i markedet for linkbuilding bureauer, så vi har gjort arbejdet for dig.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Vi sammenligner de forskellige linkbuilding bureauer i Danmark og præsenterer information om:
            </p>
          ...
          <section className="mb-8">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-600 p-4 mt-4">
              <p className="text-gray-700">
                <strong>Email:</strong> kontakt@link-eksperten.dk<br/>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Link-Eksperten.dk fungerer som en informationsplatform. Vi er ikke ansvarlige for transaktioner 
      ...
      <footer className="bg-gray-900 text-gray-300 py-8 mt-16">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <p className="text-sm">&copy; 2026 Link-Eksperten.dk - Alle rettigheder forbeholdes</p>
        </div>
      </footer>
    </div>
  )
